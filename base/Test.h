...
// note: this method originally returned VOID, but I have changed it so it yields hits@1 in filtered scenario
double test_link_prediction() {
    l_rank /= testTotal;
    r_rank /= testTotal;
    ...
    // RETURN THE HITS@1 IN FILTERED SCENARIO
